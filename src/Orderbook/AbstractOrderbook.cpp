...
namespace TradingEngine::Orderbook {
	AbstractOrderbook::AbstractOrderbook(Orderbook orderbook, MatchingAlgorithm::FifoMatchingAlgorithm matchingAlgorithm)
	...
	//MatchOrderBookResult AbstractOrderbook::match()
	//{
	//	std::lock_guard<std::mutex> guard(ob_mutex);
	//	return orderbook_.getCount();
	//	return MatchOrderBookResult();
	//}
}
